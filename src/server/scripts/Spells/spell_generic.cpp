...
void AddSC_generic_spell_scripts()
{
    ...
    new spell_gen_mount("spell_Drake_of_the_East_Wind", 0, 1088335, 2088335, 3088335, 4088335);
    new spell_gen_mount("spell_Phosphorescent_Stone_Drake", 0, 1088718, 2088718, 3088718, 4088718);
new spell_gen_mount("spell_Drake_of_the_West_Wind", 0, 1088741, 2088741, 3088741, 4088741);
new spell_gen_mount("spell_Drake_of_the_North_Wind", 0, 1088742, 2088742, 3088742, 4088742);
new spell_gen_mount("spell_Drake_of_the_South_Wind", 0, 1088744, 2088744, 3088744, 4088744);
new spell_gen_mount("spell_Vitreous_Stone_Drake", 0, 1088746, 2088746, 3088746, 4088746);
new spell_gen_mount("spell_Dark_Phoenix", 0, 1088990, 2088990, 3088990, 4088990);
new spell_gen_mount("spell_Sandstone_Drake", 0, 1093326, 2093326, 3093326, 4093326);
new spell_gen_mount("spell_Mottled_Drake", 0, 1093623, 2093623, 3093623, 4093623);
new spell_gen_mount("spell_Amani_Dragonhawk", 0, 1096503, 2096503, 3096503, 4096503);
new spell_gen_mount("spell_Flameward_Hippogryph", 0, 1097359, 2097359, 3097359, 4097359);
new spell_gen_mount("spell_Pureblood_Fire_Hawk", 0, 1097493, 2097493, 3097493, 4097493);
new spell_gen_mount("spell_Felfire_Hawk", 0, 1097501, 2097501, 3097501, 4097501);
new spell_gen_mount("spell_Corrupted_Fire_Hawk", 0, 1097560, 2097560, 3097560, 4097560);
new spell_gen_mount("spell_Winged_Guardian", 0, 1098727, 2098727, 3098727, 4098727);
new spell_gen_mount("spell_Vicious_Gladiators_Twilight_Drake", 0, 1101282, 2101282, 3101282, 4101282);
new spell_gen_mount("spell_Ruthless_Gladiators_Twilight_Drake", 0, 1101821, 2101821, 3101821, 4101821);
new spell_gen_mount("spell_Corrupted_Hippogryph", 0, 1102514, 2102514, 3102514, 4102514);
new spell_gen_mount("spell_Tyraels_Charger", 0, 1107203, 2107203, 3107203, 4107203);
new spell_gen_mount("spell_Spectral_Wind_Rider", 0, 1107517, 2107517, 3107517, 4107517);
new spell_gen_mount("spell_Blazing_Drake", 0, 1107842, 2107842, 3107842, 4107842);
new spell_gen_mount("spell_Twilight_Harbinger", 0, 1107844, 2107844, 3107844, 4107844);
new spell_gen_mount("spell_Life_Binders_Handmaiden", 0, 1107845, 2107845, 3107845, 4107845);
new spell_gen_mount("spell_Experiment_12_B", 0, 1110039, 2110039, 3110039, 4110039);
new spell_gen_mount("spell_Heart_of_the_Aspects", 0, 1110051, 2110051, 3110051, 4110051);
new spell_gen_mount("spell_Feldrake", 0, 1113120, 2113120, 3113120, 4113120);
new spell_gen_mount("spell_Jade_Cloud_Serpent", 0, 1113199, 2113199, 3113199, 4113199);
new spell_gen_mount("spell_Pandaren_Kite", 0, 1118737, 2118737, 3118737, 4118737);
new spell_gen_mount("spell_Cindermane_Charger", 0, 1171847, 2171847, 3171847, 4171847);
new spell_gen_mount("spell_Obsidian_Nightwing", 0, 1121820, 2121820, 3121820, 4121820);
new spell_gen_mount("spell_Azure_Cloud_Serpent", 0, 1123992, 2123992, 3123992, 4123992);
new spell_gen_mount("spell_Golden_Cloud_Serpent", 0, 1123993, 2123993, 3123993, 4123993);
new spell_gen_mount("spell_Thundering_Jade_Cloud_Serpent", 0, 1124408, 2124408, 3124408, 4124408);
new spell_gen_mount("spell_Cataclysmic_Gladiators_Twilight_Drake", 0, 1124550, 2124550, 3124550, 4124550);
new spell_gen_mount("spell_Imperial_Quilen", 0, 1124659, 2124659, 3124659, 4124659);
new spell_gen_mount("spell_Depleted_Kyparium_Rocket", 0, 1126507, 2126507, 3126507, 4126507);
new spell_gen_mount("spell_Geosynchronous_World_Spinner", 0, 1126508, 2126508, 3126508, 4126508);
new spell_gen_mount("spell_Onyx_Cloud_Serpent", 0, 1127154, 2127154, 3127154, 4127154);
new spell_gen_mount("spell_Crimson_Cloud_Serpent", 0, 1127156, 2127156, 3127156, 4127156);
new spell_gen_mount("spell_Heavenly_Onyx_Cloud_Serpent", 0, 1127158, 2127158, 3127158, 4127158);
new spell_gen_mount("spell_Heavenly_Crimson_Cloud_Serpent", 0, 1127161, 2127161, 3127161, 4127161);
new spell_gen_mount("spell_Heavenly_Golden_Cloud_Serpent", 0, 1127164, 2127164, 3127164, 4127164);
new spell_gen_mount("spell_Heavenly_Jade_Cloud_Serpent", 0, 1127165, 2127165, 3127165, 4127165);
new spell_gen_mount("spell_Heavenly_Azure_Cloud_Serpent", 0, 1127169, 2127169, 3127169, 4127169);
new spell_gen_mount("spell_Astral_Cloud_Serpent", 0, 1127170, 2127170, 3127170, 4127170);
new spell_gen_mount("spell_Crimson_Pandaren_Phoenix", 0, 1129552, 2129552, 3129552, 4129552);
new spell_gen_mount("spell_Thundering_August_Cloud_Serpent", 0, 1129918, 2129918, 3129918, 4129918);
new spell_gen_mount("spell_Red_Flying_Cloud", 0, 1130092, 2130092, 3130092, 4130092);
new spell_gen_mount("spell_Thundering_Ruby_Cloud_Serpent", 0, 1132036, 2132036, 3132036, 4132036);
new spell_gen_mount("spell_Ashen_Pandaren_Phoenix", 0, 1132117, 2132117, 3132117, 4132117);
new spell_gen_mount("spell_Emerald_Pandaren_Phoenix", 0, 1132118, 2132118, 3132118, 4132118);
new spell_gen_mount("spell_Violet_Pandaren_Phoenix", 0, 1132119, 2132119, 3132119, 4132119);
new spell_gen_mount("spell_Jade_Pandaren_Kite", 0, 1133023, 2133023, 3133023, 4133023);
new spell_gen_mount("spell_Sky_Golem", 0, 1134359, 2134359, 3134359, 4134359);
new spell_gen_mount("spell_Grand_Armored_Gryphon", 0, 1135416, 2135416, 3135416, 4135416);
new spell_gen_mount("spell_Grand_Armored_Wyvern", 0, 1135418, 2135418, 3135418, 4135418);
new spell_gen_mount("spell_Grand_Gryphon", 0, 1136163, 2136163, 3136163, 4136163);
new spell_gen_mount("spell_Grand_Wyvern", 0, 1136164, 2136164, 3136164, 4136164);
new spell_gen_mount("spell_Armored_Skyscreamer", 0, 1136400, 2136400, 3136400, 4136400);
new spell_gen_mount("spell_Malevolent_Gladiators_Cloud_Serpent", 0, 1139407, 2139407, 3139407, 4139407);
new spell_gen_mount("spell_Thundering_Cobalt_Cloud_Serpent", 0, 1139442, 2139442, 3139442, 4139442);
new spell_gen_mount("spell_Clutch_of_Ji_Kun", 0, 1139448, 2139448, 3139448, 4139448);
new spell_gen_mount("spell_Armored_Bloodwing", 0, 1139595, 2139595, 3139595, 4139595);
new spell_gen_mount("spell_Hearthsteed", 0, 1142073, 2142073, 3142073, 4142073);
new spell_gen_mount("spell_Armored_Red_Dragonhawk", 0, 1142266, 2142266, 3142266, 4142266);
new spell_gen_mount("spell_Armored_Blue_Dragonhawk", 0, 1142478, 2142478, 3142478, 4142478);
new spell_gen_mount("spell_Enchanted_Fey_Dragon", 0, 1142878, 2142878, 3142878, 4142878);
new spell_gen_mount("spell_Spawn_of_Galakras", 0, 1148392, 2148392, 3148392, 4148392);
new spell_gen_mount("spell_Thundering_Onyx_Cloud_Serpent", 0, 1148476, 2148476, 3148476, 4148476);
new spell_gen_mount("spell_Tyrannical_Gladiators_Cloud_Serpent", 0, 1148618, 2148618, 3148618, 4148618);
new spell_gen_mount("spell_Grievous_Gladiators_Cloud_Serpent", 0, 1148619, 2148619, 3148619, 4148619);
new spell_gen_mount("spell_Prideful_Gladiators_Cloud_Serpent", 0, 1148620, 2148620, 3148620, 4148620);
new spell_gen_mount("spell_Emerald_Hippogryph", 0, 1149801, 2149801, 3149801, 4149801);
new spell_gen_mount("spell_Iron_Skyreaver", 0, 1153489, 2153489, 3153489, 4153489);
new spell_gen_mount("spell_Dread_Raven", 0, 1155741, 2155741, 3155741, 4155741);
new spell_gen_mount("spell_Creeping_Carpet", 0, 1169952, 2169952, 3169952, 4169952);
new spell_gen_mount("spell_Solar_Spirehawk", 0, 1171828, 2171828, 3171828, 4171828);
new spell_gen_mount("spell_Emerald_Drake", 0, 1175700, 2175700, 3175700, 4175700);
new spell_gen_mount("spell_Felsteel_Annihilator", 0, 1182912, 2182912, 3182912, 4182912);
new spell_gen_mount("spell_Corrupted_Dreadwing", 0, 1183117, 2183117, 3183117, 4183117);
new spell_gen_mount("spell_Swift_Spectral_Rylak", 0, 1194046, 2194046, 3194046, 4194046);
new spell_gen_mount("spell_Eclipse_Dragonhawk", 0, 1194464, 2194464, 3194464, 4194464);
new spell_gen_mount("spell_Infinite_Timereaver", 0, 1201098, 2201098, 3201098, 4201098);
new spell_gen_mount("spell_Spectral_Gryphon", 0, 1107516, 2107516, 3107516, 4107516);
new spell_gen_mount("spell_Jeweled_Onyx_Panther", 0, 1120043, 2120043, 3120043, 4120043);
new spell_gen_mount("spell_Sapphire_Panther", 0, 1121836, 2121836, 3121836, 4121836);
new spell_gen_mount("spell_Jade_Panther", 0, 1121837, 2121837, 3121837, 4121837);
new spell_gen_mount("spell_Ruby_Panther", 0, 1121838, 2121838, 3121838, 4121838);
new spell_gen_mount("spell_Sunstone_Panther", 0, 1121839, 2121839, 3121839, 4121839);
new spell_gen_mount("spell_Swift_Windsteed", 0, 1134573, 2134573, 3134573, 4134573);
new spell_gen_mount("spell_Ghastly_Charger", 0, 1136505, 2136505, 3136505, 4136505);
new spell_gen_mount("spell_Ironbound_Wraithcharger", 0, 1142910, 2142910, 3142910, 4142910);
new spell_gen_mount("spell_Warforged_Nightmare", 0, 1163024, 2163024, 3163024, 4163024);
new spell_gen_mount("spell_Grinning_Reaver", 0, 1163025, 2163025, 3163025, 4163025);
new spell_gen_mount("spell_Mystic_Runesaber", 0, 1180545, 2180545, 3180545, 4180545);
new spell_gen_mount("spell_Grove_Warden", 0, 1189999, 2189999, 3189999, 4189999);
new spell_gen_mount("spell_Soaring_Skyterror", 0, 1191633, 2191633, 3191633, 4191633);
